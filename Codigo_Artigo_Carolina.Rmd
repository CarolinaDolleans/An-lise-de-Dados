...
Esse banco foi extraido do endereço seguinte: https://www.tse.jus.br/eleicoes/estatisticas/repositorio-de-dados-eleitorais-1/repositorio-de-dados-eleitorais

O banco que utilizei é aquele chamado de Candidatos (formato ZIP)
...
O banco que utilizei é aquele chamado de Votação nominal por município e zona (formato ZIP)
